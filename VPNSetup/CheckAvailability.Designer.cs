namespace VPNSetup
{
  partial class CheckAvailability
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label2.Text = "Microsoft Virtual Hosted Network";
      // 
      // label3
      // 
      ...
      this.label3.Text = "Internet Connection";
      // 
      // label4
      // 
      ...
      this.label4.Text = "Express VPN Adapter";
      // 
      // label5
      // 
      ...
      this.label5.Text = "Shared and Remote Access";
      // 
      // label6
      // 
