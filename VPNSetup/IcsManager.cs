...
namespace VPNSetup
{
  public class IcsManager
  {
    ...
    public static void disableSharing(INetConnection connectionToShare, INetConnection homeConnection)
    {
    ...
    {
      disableSharing(connectionToShare, homeConnection);
